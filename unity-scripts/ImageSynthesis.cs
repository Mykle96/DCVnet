...
public class ImageSynthesis : MonoBehaviour {
	...
	struct CapturePass {
		...
		public CapturePass(string name_) { name = name_; supportsAntialiasing = false; needsRescale = false; camera = null; }
	...
	public void OnSceneChange(bool grayscale=false)
	{
		...
		foreach (var r in renderers)
		{
			...
			//	Only color containers based on ID, all other gameobjects are colored red
			if (r.gameObject.name.Contains("Container"))
			{
